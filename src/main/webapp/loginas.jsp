...
<head>
    ...
    <style>
        body {
            background-image: url("/images/Loginas.jpg");
            width: 100%;
        }
    ...
    <div>
        <div class="content" id="loginas">
            ...
            <form action="AdminLogin.jsp">
                <button class="button " type="button "  href="AdminLogin.jsp ">
                 Admin
                </button>
            </form>
            <br>
            <form action="studentlo.jsp">
                <button class="button " type="button "  href="studentlo.jsp ">
                 Student
                </button>
            </form>
            <br>
            <form action="companylogin.jsp ">
                <button class="button " type="button " onclick="myFunction2() " href="companylogin.jsp ">
