...
public class Jobs 
{
    ...
    @Column(name = "reqtenthpercentage",nullable = false)
    private int reqtenth;
    
    @Column(name = "reqinterpercentage",nullable = false)
    private int reqinter;
    
    @Column(name = "reqcgpa",nullable = false)
    private int reqcgpa;
	...
	public int getReqtenth() {
		return reqtenth;
	}

	public void setReqtenth(int reqtenth) {
		this.reqtenth = reqtenth;
	}

	public int getReqinter() {
		return reqinter;
	}

	public void setReqinter(int reqinter) {
		this.reqinter = reqinter;
	}

	public int getReqcgpa() {
		return reqcgpa;
	}

	public void setReqcgpa(int reqcgpa) {
