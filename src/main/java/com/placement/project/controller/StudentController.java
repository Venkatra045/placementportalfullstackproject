...
public class StudentController {
	...
	public ModelAndView insertstudent(HttpServletRequest request)
	{
		...
		student.setStudentstatus("REGISTERD");
	...
	@GetMapping("studentlo")
	public ModelAndView studentlogin()
	{
		ModelAndView mv = new ModelAndView();
		mv.setViewName("studentlo");
		return mv;
	}
	...
	@PostMapping("checkstudentlogin")
	  public ModelAndView checkstudentlogin(HttpServletRequest request) {
	    ...
	    if(st!=null) {
	      if(st.getStudentstatus().equals("APPROVED")) {
	        session.setAttribute("student",st);
	        mv.setViewName("studenthome");
	        return mv;
	      }
	      else if(st.getStudentstatus().equals("REJECTED")) {
	        mv.setViewName("studentlo");
	        mv.addObject("message","YOU HAVE REJECTED");
	        return mv;
	      }else
	      {
	        mv.setViewName("studentlo");
	        mv.addObject("message","YOU HAVE NOT APPROVED");
	        return mv;
	      }
